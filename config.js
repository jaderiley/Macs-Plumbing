...
const CONFIG = {
  ...
  business: {
    ...
    phone:     "",
    whatsapp:  "",
    address:   "62 Milner Ave, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Mac's Plumbing — Plumber in randburg",
    description: "Mac's Plumbing provides professional plumber in Randburg. 1 Google review. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Mac's Plumbing provides fast, reliable plumbing services for homes and businesses across Randburg and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "Mac's Plumbing team at work in Randburg",
